...
lat = "51.3765096" # Iserlohn
lon = "7.6960842"
api_key_weather = "2c6b7c0e587b93a9feeb0732df3e525e"
api_key_news = "cc035f7c6b24476d88e9cfc745d3b213"
...
def main():
    ...
    # UPDATED AT
    display.draw_black.text((10, 8), "Aktualisiert am " + weather.current_time(), fill=0, font=font8)
    ...
    try :
        ...
        # FRAME
        display.draw_black.text((20, 150), "Regen innerhalb einer Stunde - " + time.strftime("%H:%M", time.localtime()), fill=0,
