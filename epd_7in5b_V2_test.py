...
try:
    ...
    font24 = ImageFont.truetype("/home/pi/weather/pic/Font.ttc", 24)
    font18 = ImageFont.truetype("/home/pi/weather/pic/Font.ttc", 18)
    ...
    Himage = Image.open("/home/pi/weather/pic/7in5_V2_b.bmp")
    Himage_Other = Image.open("/home/pi/weather/pic/7in5_V2_r.bmp")
    ...
    bmp = Image.open("/home/pi/weather/pic/2in9.bmp")
